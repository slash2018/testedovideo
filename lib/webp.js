...
function _classPrivateMethodGet(receiver, privateSet, fn) {
  if (!privateSet.has(receiver)) {
    throw new TypeError("tentou obter campo privado em não instância");
  }
  return fn;
}
...
class Image {
  ...
  demuxAnim(path, frame = -1, prefix = "#FNAME#") {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (end == 0) {
        throw new Error("Este WebP não é uma animação");
      }
    ...
    return _asyncToGenerator(function* () {
      ...
      switch (r.type) {
        ...
        case constants.TYPE_EXTENDED:
          if (r.hasAnim) {
            throw new Error("Não há suporte para mesclagem de animações no momento");
          }

          break;

        default:
          throw new Error("Tipo de WebP desconhecido");
      }
...
var _readHeader2 = /*#__PURE__*/ (function () {
  var _readHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (bytesRead != 12) {
      throw new Error("Fim do arquivo alcançado durante a leitura do cabeçalho");
    }
...
var _readChunkHeader2 = /*#__PURE__*/ (function () {
  var _readChunkHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (bytesRead == 0) {
      ...
      throw new Error("Fim do arquivo alcançado durante a leitura do cabeçalho do trecho");
    }
